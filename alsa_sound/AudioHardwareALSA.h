...
class AudioStreamOutALSA : public android_audio_legacy::AudioStreamOut, public ALSAStreamOps
{
public:
...
class AudioStreamInALSA : public android_audio_legacy::AudioStreamIn, public ALSAStreamOps
{
public:
	...
	//jzl::android 4.0 added. While,in AudioHardwareInterface.h there are two new members,which make creat fault.	
...
class AudioHardwareALSA : public android_audio_legacy::AudioHardwareBase
{
public:
    AudioHardwareALSA();
