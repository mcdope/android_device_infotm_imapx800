...
void
AudioHardwareALSA::closeOutputStream(android_audio_legacy::AudioStreamOut* out)
{
    delete out;
}

android_audio_legacy::AudioStreamIn *
...
void
AudioHardwareALSA::closeInputStream(android_audio_legacy::AudioStreamIn* in)
{
    delete in;
}
...
size_t AudioHardwareALSA::getInputBufferSize(uint32_t sampleRate, int format, int channelCount)
{
    ...
    */
    ...
    bufSize = 1024 * channelCount * sizeof(int16_t);
    if (8000 == sampleRate) {
        bufSize /= 4;
