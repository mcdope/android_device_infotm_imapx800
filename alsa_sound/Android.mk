...
ifeq ($(strip $(BOARD_USES_ALSA_AUDIO)),true)
  ...
  LOCAL_C_INCLUDES += external/alsa-lib/include\
					  hardware/hardware_legacy/include
  ...
  LOCAL_WHOLE_STATIC_LIBRARIES += libaudiohw_legacy libmedia_helper
...
include $(CLEAR_VARS)
  ...
  LOCAL_WHOLE_STATIC_LIBRARIES += libaudiopolicy_legacy  libmedia_helper
  LOCAL_SHARED_LIBRARIES := \
    libcutils \
    libutils \
    libmedia \
