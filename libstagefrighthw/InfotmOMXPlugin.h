...
#ifndef INFOTM_OMX_PLUGIN_H_

#define INFOTM_OMX_PLUGIN_H_

#include <media/hardware/OMXPluginBase.h>

namespace android {

struct InfotmOMXPlugin : public OMXPluginBase {
    InfotmOMXPlugin();
    virtual ~InfotmOMXPlugin();
...
private:
    ...
    InfotmOMXPlugin(const InfotmOMXPlugin &);
    InfotmOMXPlugin &operator=(const InfotmOMXPlugin &);
};

}  // namespace android

#endif  // Infotm_OMX_PLUGIN_H_
